...
<table id="rejillaPantalla" cols="4" cellpadding="0px" cellspacing="0px" align="center" width="1090">
<tr>
...
<td width="250" align="center" style="font-size:12px;">
<p style="text-decoration:underline;"><strong>Missatges resposta</strong></p>
<?php
...
<td width="250" align="center" style="font-size:12px;">
<p style="text-decoration:underline;"><strong>Paraules escrites</strong></p>
<?php
...
<td colspan="4" align="center" style="font-size:12px;" height="250" valign="bottom">
...
<p style="text-decoration:underline;"><strong><br/>Distribució dels missatges lliurats per l'estudiant</strong></p>
  
    <div id="contenedorGráfica1" style="width:1000px; height:200px; overflow-x:auto; overflow-y:hidden;">
